...
class Imageshape:  # creación clase
    def __init__(self, width, height):
        self.width = width
        self.height = height
        self.shape = []  # se guarda la imagen creada
        self.num = 0  # numero aleatorio
        self.name_shape = ''  # nombre de la figura obtenido en get shape
        self.figure = ''  # clasificación de la figura en what shape
